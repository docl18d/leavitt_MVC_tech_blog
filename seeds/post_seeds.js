...
const postData = [{
        name: 'Bjorn Longship',
        description: "Viking boats the kracken lack the table viking ocean scandinavia swords berserker. Swords loot axes tall blond women, scandinavia boats berserker raiding berserker terror viking viking scandinavia bjorn the chair.",
        user_id: 1
